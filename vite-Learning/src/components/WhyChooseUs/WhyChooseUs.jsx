  ...
  return (
    <div className="bg-[#f9fafc]">
      <div className="container py-24">
        ...
        {/* cards section */}
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4 group">
          {WhyChooseData.map((item) => {
            return (
              <motion.div
                ...
                initial="hidden"
                whileInView={"visible"}
                className="space-y-4 p-6 rounded-xl cursor-pointer group-hover:blur-sm hover:!blur-none group-hover:scale-[1] hover:!scale-100 shadow-[0_0_22px_rgba(0,0,0,0.15)]"
              >
                {/* icon section */}
                <div
