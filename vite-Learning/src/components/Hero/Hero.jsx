        ...
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="space-y-6 text-center md:text-left">
            ...
            >
              ...
              <button className="flex items-center justify-end gap-2 font-semibold">
                <span className="flex items-center justify-center w-10 h-10 rounded-full bg-secondary/15">
